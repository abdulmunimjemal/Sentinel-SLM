...
from src.sentinel.utils.taxonomy import Category, CATEGORY_NAMES, MAPPING_RULES
        ...
        for line in f:
            ...
            try:
                ...
                if label_str not in name_to_id:
                     if "Sexual" in label_str: cat_id = Category.SEXUAL
                     elif "Child" in label_str: cat_id = Category.CHILD_SAFETY
                     elif "Harassment" in label_str: cat_id = Category.HARASSMENT
                     elif "Hate" in label_str: cat_id = Category.HATE_EXTREMISM
                     elif "Prompt" in label_str: cat_id = Category.PROMPT_ATTACK
